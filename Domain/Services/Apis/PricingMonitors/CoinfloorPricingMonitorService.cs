...
{
    public class CoinfloorPricingMonitorService : IAmPricingMonitor
    {
        ...
        public CoinfloorPricingMonitorService(IAmAnApiService apiService, Exchange exchange) : this(apiService, exchange, new BuilderFactory())
        { }

        public CoinfloorPricingMonitorService(IAmAnApiService apiService, Exchange exchange, IBuilderFactory builderFactory)
        {
        ...
        public void Monitor()
        {
            ...
            //catch (Exception ex)
            //{
            //    Colorful.Console.WriteLine($"Coinfloor Monitor(): {ex.Message}", Color.Red);
            //}
        }
        ...
        //        catch (Exception ex)
        //        {
        //            Colorful.Console.WriteLine($"Coinfloor OnMessage(): {ex.Message}", Color.Red);
        //        }
        //    }
        //}
